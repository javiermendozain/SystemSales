 ...
 */
    ...
    class Departamento_multiselecPage extends Page
    {
    ...
    try
    {
        $Page = new Departamento_multiselecPage("Departamento_multiselec", "Departamento_multiselec.php", GetCurrentUserGrantForDataSource("Departamento_multiselec"), 'UTF-8');
        $Page->SetTitle('Departamento Multiselec');
        $Page->SetMenuLabel('Departamento Multiselec');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Departamento_multiselec"));
