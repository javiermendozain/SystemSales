    ...
    class userPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset = new QueryDataset(
              ...
              $selectQuery, $insertQuery, $updateQuery, $deleteQuery, 'user');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'user_name', 'user_name', $this->RenderText('User Name'))
            );
        }
        ...
        {
            $main_editor = new SpinEdit('user_id_edit');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new SpinEdit('user_id_edit');
