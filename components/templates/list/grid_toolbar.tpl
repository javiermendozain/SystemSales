                ...
                <div class="btn-group js-selection-actions-container fade" style="display: none">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            {if $DataGrid.AllowCompare and ($DataGrid.AllowPrintSelected or $DataGrid.AllowDeleteSelected)}
                                <li class="divider"></li>
                            {/if}

                            {if $DataGrid.AllowPrintSelected}
                                <li>
                                    <a href="#" class="js-action" data-type="print" data-url="{$Page->getLink()}">
                                        {$Captions->GetMessageString('PrintSelected')}
                                    </a>
                                </li>
                            {/if}

                            {if $DataGrid.AllowPrintSelected and $DataGrid.AllowDeleteSelected}
                                <li class="divider"></li>
                            {/if}
