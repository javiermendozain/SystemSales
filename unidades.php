 ...
 */
    ...
    class public_unidadesPage extends Page
    {
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'idunidad', 'idunidad', $this->RenderText('Idunidad')),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetPlaceholder($this->RenderText('UNIDADES DE PRODUCTOS'));
        ...
        {
            //
            // View column for idunidad field
            //
            $column = new TextViewColumn('idunidad', 'idunidad', 'Idunidad', $this->dataset);
            $column->SetOrderable(true);
    ...
    try
    {
        $Page = new public_unidadesPage("public_unidades", "unidades.php", GetCurrentUserGrantForDataSource("public.unidades"), 'UTF-8');
        $Page->SetTitle('Unidades');
        $Page->SetMenuLabel('Unidades');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.unidades"));
