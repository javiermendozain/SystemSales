 ...
 */
    ...
    class ciudadPage extends Page
    {
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'ciudad', 'ciudad', $this->RenderText('Ciudad'))
            );
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('ciudad_edit');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('ciudad', 'ciudad', 'Ciudad', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
    ...
    try
    {
        $Page = new ciudadPage("ciudad", "ciudad.php", GetCurrentUserGrantForDataSource("ciudad"), 'UTF-8');
        $Page->SetTitle('Ciudad');
        $Page->SetMenuLabel('Ciudad');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("ciudad"));
