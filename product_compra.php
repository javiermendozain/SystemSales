 ...
 */
    ...
    class product_compraPage extends Page
    {
    ...
    try
    {
        $Page = new product_compraPage("product_compra", "product_compra.php", GetCurrentUserGrantForDataSource("product_compra"), 'UTF-8');
        $Page->SetTitle('Product Compra');
        $Page->SetMenuLabel('Product Compra');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("product_compra"));
