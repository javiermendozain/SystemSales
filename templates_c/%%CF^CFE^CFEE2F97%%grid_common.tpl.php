...
?><?php echo ''; ?><?php $this->assign('operators', $this->_tpl_vars['DataGrid']['FilterBuilder']->getOperators($this->_tpl_vars['column'])); ?><?php echo ''; ?><?php echo '
        ...
        gridData.columnFilter.isSearchEnabled = '; ?><?php echo ''; ?><?php echo smarty_function_to_json(array('value' => $this->_tpl_vars['DataGrid']['ColumnFilter']->getSearchEnabled()), $this);?><?php echo ''; ?><?php echo ';
        gridData.columnFilter.excludedComponents = '; ?><?php echo ''; ?><?php echo smarty_function_to_json(array('value' => $this->_tpl_vars['DataGrid']['ColumnFilter']->getExcludedComponents()), $this);?><?php echo ''; ?><?php echo ';
