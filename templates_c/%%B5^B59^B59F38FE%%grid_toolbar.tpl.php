...
"><?php echo $this->_tpl_vars['Captions']->GetMessageString('CompareSelected'); ?>
                            ...
                            <?php if ($this->_tpl_vars['DataGrid']['AllowCompare'] && ( $this->_tpl_vars['DataGrid']['AllowPrintSelected'] || $this->_tpl_vars['DataGrid']['AllowDeleteSelected'] )): ?>
                                <li class="divider"></li>
                            <?php endif; ?>

                            <?php if ($this->_tpl_vars['DataGrid']['AllowPrintSelected']): ?>
                                <li>
                                    <a href="#" class="js-action" data-type="print" data-url="<?php echo $this->_tpl_vars['Page']->getLink(); ?>
">
                            ...
                            <?php if ($this->_tpl_vars['DataGrid']['AllowPrintSelected'] && $this->_tpl_vars['DataGrid']['AllowDeleteSelected']): ?>
                                <li class="divider"></li>
                            <?php endif; ?>
