...
<?php if ($this->_tpl_vars['child']->ShowOrderingControl() && ! $this->_tpl_vars['isInline'] && ! $this->_tpl_vars['isMasterGrid']): ?> sortable<?php endif; ?><?php if ($this->_tpl_vars['DataGrid']['ColumnFilter'] && $this->_tpl_vars['DataGrid']['ColumnFilter']->hasColumn($this->_tpl_vars['child']->getName())): ?> filterable<?php endif; ?>"
