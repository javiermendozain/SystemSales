 ...
 */
    ...
    class producto_ventaPage extends Page
    {
        ...
        {
            $main_editor = new SpinEdit('idproducto_edit');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new SpinEdit('idproducto_edit');
            $editColumn = new CustomEditColumn('Idproducto', 'idproducto', $editor, $this->dataset);
    ...
    try
    {
        $Page = new producto_ventaPage("producto_venta", "producto_venta.php", GetCurrentUserGrantForDataSource("producto_venta"), 'UTF-8');
        $Page->SetTitle('Producto Venta');
        $Page->SetMenuLabel('Producto Venta');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("producto_venta"));
